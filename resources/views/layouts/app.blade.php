...
@section('app')
    <nav class="sb-topnav navbar navbar-expand" style="background-color: #006cc0;">
        <a class="navbar-brand ps-3 fs-5 text-light" href="{{ route('dashboard') }}">TARGET PRIMA LESTARI</a>
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            ...
            {{-- Footer --}}
            <footer class="py-4 mt-auto" style="background-color: #e7e7e6;">
                <div class="container-fluid px-4">
                    <div class="d-flex align-items-end justify-content-end small">
                        <div class="text-muted">Copyright &copy; PT. Target Prima Lestari</div>
                    </div>
                </div>
            </footer>
        </div>
